...
**当前版本：1.4.2**（e-receipt 系统分享 + 7 天缓存、今日列表溢出修复）· 品牌 **黄金发宝号** · 上一版 1.4.1
...
| 电子收据 | 系统分享 PDF（选 WhatsApp，不自动 wa.me）；私有缓存 7 天；设置可清空 |
| 今日 | 销售列表、搜索单号/手机/客户 |
...
| Tag | 要点 |
|-----|------|
| **v1.4.2-mobile** | 黄金发宝号；e-receipt 系统分享 + 7 天缓存；今日列表溢出修复 |
